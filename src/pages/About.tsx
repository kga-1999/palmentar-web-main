...
const About = () => {
  ...
  const team = [
    {
      name: 'Zyead Al-khodani',
      role: 'General of Manager',
      image: '/palmentar-web-main/images/team/zeyad.jpg',
      description: 'PhD in Chemistry with 20+ years experience in natural product development and sustainable manufacturing'
    },
    {
      name: 'shawqi Al-haji',
      role: 'Supply Chain Head',
      image: '/palmentar-web-main/images/team/shawqi.jpg',
    ...
    },
    {
      ...
      image: '/palmentar-web-main/images/team/sam.jpg',
      description: 'Certified quality assurance specialist with expertise in organic certification and international standards'
    },
    {
      name: 'Khalid Al-amri',
      role: 'IT support and Technology Manager',
      image: '/palmentar-web-main/images/team/khaled.jpeg',
      description: '2 years managing eco-friendly manufacturing processes and sustainable production lines'
    }
  ];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative animate-fade-in delay-300">
              <div className="bg-card rounded-3xl p-8 shadow-2xl luxury-shadow">
                <img
                  src="/palmentar-web-main/images/factory.jpg"
